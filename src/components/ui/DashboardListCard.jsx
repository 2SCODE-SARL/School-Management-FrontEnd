 ...
 * contexte : élève, demande, réclamation...).
 */
export function DashboardListCard({ title, total, items, renderItem, emptyMessage = 'Rien à afficher pour l’instant.', onSeeAll, isLoading }) {
  return (
